...
1. Download and unpack the latest version of Webmail Pro 8 into your installation root directory (currently it's version 0.6.0)  `https://github.com/afterlogic/webmail-pro-8/archive/0.6.0.zip`
